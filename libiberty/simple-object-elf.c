...
#define CGCMAG0		   0x7F	/* Magic number byte 0 */

#define EI_MAG1		1	/* File identification byte 1 index */
#define ELFMAG1		    'E'	/* Magic number byte 1 */
#define CGCMAG1		    'C'	/* Magic number byte 1 */

#define EI_MAG2		2	/* File identification byte 2 index */
#define ELFMAG2		    'L'	/* Magic number byte 2 */
#define CGCMAG2		    'G'	/* Magic number byte 2 */

#define EI_MAG3		3	/* File identification byte 3 index */
#define ELFMAG3		    'F'	/* Magic number byte 3 */
#define CGCMAG3		    'C'	/* Magic number byte 3 */
...
static int is_elf_or_cgc(const unsigned char *header) {
   ...
   else if (header[EI_MAG0] == CGCMAG0
      || header[EI_MAG1] == CGCMAG1
      || header[EI_MAG2] == CGCMAG2
      || header[EI_MAG3] == CGCMAG3
      || header[EI_VERSION] == EV_CURRENT) {
      return 1;
   }
   return 0;
