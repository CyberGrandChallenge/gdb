...
static inline bfd_boolean
cgc_file_p (Elf_External_Ehdr *x_ehdrp)
{
  return ((x_ehdrp->e_ident[EI_MAG0] == CGCMAG0)
	  && (x_ehdrp->e_ident[EI_MAG1] == CGCMAG1)
	  && (x_ehdrp->e_ident[EI_MAG2] == CGCMAG2)
	  && (x_ehdrp->e_ident[EI_MAG3] == CGCMAG3));
}
...
elf_object_p (bfd *abfd)
{
  ...
  if (! (elf_file_p (&x_ehdr) || cgc_file_p(&x_ehdr))
